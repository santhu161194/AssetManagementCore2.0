...
public class AssetDaoImpl implements AssetDao {
	...
	@Override
	public int addAssetType(final assetType) {
	...
	@Override
	public List<Asset> getAllAssetTypes() throws DataAccessException {
		return template.query(Queries.getAllAssetTypes, new RowMapper<Asset>() {
			public Asset mapRow(ResultSet rs, int row) throws SQLException {
				Asset e = new Asset();
				
				e.setAssetType(rs.getString(1));
	...
	@Override
	public Asset getAssetType(long assetId) throws DataAccessException {
		Object args[] = { assetId };

		return template.query(Queries.getAssetType, args,
				new ResultSetExtractor<Asset>() {
